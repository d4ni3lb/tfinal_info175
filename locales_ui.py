...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.botonEliminar.setText(QtGui.QApplication.translate("Form", "Eliminar local", None, QtGui.QApplication.UnicodeUTF8))
        self.botonNuevoL.setText(QtGui.QApplication.translate("Form", "Nuevo local", None, QtGui.QApplication.UnicodeUTF8))
        self.botonEditar.setText(QtGui.QApplication.translate("Form", "Editar local", None, QtGui.QApplication.UnicodeUTF8))
